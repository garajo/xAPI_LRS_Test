...
Scenario: Good delete agent profile: typical request cluster with agent parameter set to an [value] agent
...
Scenario: Bad delete agent profile: typical request missing [property]
...
Scenario: Bad delete agent profile: typical request with bad [property] '[value]'
...
Scenario: Bad delete agent profile: typical request with [modifier] agent parameter with bad [property] '[value]'
...
Scenario: Bad delete agent profile: typical request with [modifier] agent parameter missing [property]
