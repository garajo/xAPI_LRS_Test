...
Scenario: Good save activity profile: [type] request
...
Scenario: Good save activity profile: [type] request missing [property]
...
Scenario: Good save activity profile: [type] request with [property] set to '[value]'
...
Scenario: Bad save activity profile: typical request with bad [property] '[value]'
