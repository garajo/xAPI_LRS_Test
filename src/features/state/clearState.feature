...
Scenario: Bad clear state: [type] request with bad agent parameter an empty agent
...
Scenario: Bad clear state: typical request with [modifier] agent parameter with bad [property] '[value]'
...
Scenario: Bad clear state: typical request with [modifier] agent parameter missing [property]
