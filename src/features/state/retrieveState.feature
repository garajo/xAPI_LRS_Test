...
Scenario: Good retrieve state: [type] request cluster with agent parameter set to an [value] agent
...
Scenario: Good retrieve state: [type] request cluster with stateId parameter set to 'test state id'
...
Scenario: Bad retrieve state: [type] request with bad agent parameter an empty agent
...
Scenario: Bad retrieve state: typical request with [modifier] agent parameter with bad [property] '[value]'
...
Scenario: Bad retrieve state: typical request with [modifier] agent parameter missing [property]
